            ...
            <div className="container">
                ...
                <form className="register-details-wrapper" onSubmit={submithandler}>
                    <div className="personalInfo">
                        ...
                        <hr className='r-hr' />
                        <h4 className='desc'>Plese enter the following information to create Account</h4>
                        <div className="name">
                        ...
                        <input
                            ...
                            ref={email}
                        />
                        <label htmlFor="mobile" className="inputlabel">Mobile No*</label>
                        <input
                            type="mobile"
                            id='mobile'
                            className='r-inputfield'
                    ...
                    <div className="loginInfo">
                        ...
                        <div className="password">
                            ...
                            <div className="pass-right">
                                <label htmlFor="conformpass" className="inputlabel">Conform Password*</label>
                                <input
                                    type="text"
                                    id='conformpass'
                                    className='r-inputfield'
